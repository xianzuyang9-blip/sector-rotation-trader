...
Updated (UTC): 2026-05-29T23:59:45

Normal models: 5

| Algo ID | Name | Frequency |
| --- | --- | --- |
| faber | Faber Momentum Rotation | monthly_eom |
| dmsr | Antonacci Dual Momentum Sector Rotation | monthly_eom |
| simple_monthly | Quantified Simple Monthly Rotation | monthly_eom |
...
| Algo ID | Name | Frequency |
| --- | --- | --- |
| tsa | TSA Body Count | daily |
| cardboard | Cardboard Box Index | monthly |
| craigslist | Craigslist Desperation Index | weekly |
| glassdoor | Glassdoor Misery Gradient | monthly |
| calls311 | 311 Call Rotation | weekly |
| liquor | Liquor Store Leading Indicator | monthly |
