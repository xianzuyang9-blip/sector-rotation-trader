...
class HealthcareUtilizationSurgeFromSeasonalIllnessWaveAlgo(CrazyAlgoBase):
    algo_id = "healthcare-utilization-surge-from-seasonal-illness-wave"
    name = "Healthcare Utilization Surge From Seasonal Illness Wave"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='urgent care near me', days_back=180)
