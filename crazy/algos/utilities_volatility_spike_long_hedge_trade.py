...
class UtilitiesVolatilitySpikeLongHedgeTradeAlgo(CrazyAlgoBase):
    algo_id = "utilities-volatility-spike-long-hedge-trade"
    name = "Utilities Volatility Spike Long Hedge Trade"
