...
class FoodPriceInflationRssSpikeSignalsConsumerStaplesPricAlgo(CrazyAlgoBase):
    algo_id = "food-price-inflation-rss-spike-signals-consumer-staples-pric"
    name = "Food Price Inflation Rss Spike Signals Consumer Staples Pricing Power"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=grocery+price+increase&hl=en-US&gl=US&ceid=US:en'], days_back=180)
