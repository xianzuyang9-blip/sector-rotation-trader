...
class WeeklySurgeInGoogleTrendsForDiyHomeRepairKitSearchAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-diy-home-repair-kit-search"
    name = "Weekly Surge In Google Trends For Diy Home Repair Kit Searches"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='DIY home repair kit', days_back=180)
