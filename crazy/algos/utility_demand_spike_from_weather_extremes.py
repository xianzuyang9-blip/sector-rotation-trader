...
class UtilityDemandSpikeFromWeatherExtremesAlgo(CrazyAlgoBase):
    algo_id = "utility-demand-spike-from-weather-extremes"
    name = "Utility Demand Spike From Weather Extremes"
