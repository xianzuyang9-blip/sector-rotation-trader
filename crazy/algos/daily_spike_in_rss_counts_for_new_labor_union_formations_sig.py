...
class DailySpikeInRssCountsForNewLaborUnionFormationsSigAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-counts-for-new-labor-union-formations-sig"
    name = "Daily Spike In Rss Counts For New Labor Union Formations Signals Labor Market Shift"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=new+labor+union&hl=en-US&gl=US&ceid=US:en'], days_back=180)
