...
class WeeklySpikeInLaborJobsGoogleTrendsForGigWorkerStriAlgo(CrazyAlgoBase):
    algo_id = "weekly-spike-in-labor-jobs-google-trends-for-gig-worker-stri"
    name = "Weekly Spike In Labor Jobs Google Trends For Gig Worker Strike"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='gig worker strike', days_back=180)
