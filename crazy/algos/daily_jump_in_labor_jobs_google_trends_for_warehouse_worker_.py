...
class DailyJumpInLaborJobsGoogleTrendsForWarehouseWorkerAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-labor-jobs-google-trends-for-warehouse-worker-"
    name = "Daily Jump In Labor Jobs Google Trends For Warehouse Worker Shortage"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='warehouse worker shortage', days_back=180)
