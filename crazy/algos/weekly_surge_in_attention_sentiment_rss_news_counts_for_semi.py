...
class WeeklySurgeInAttentionSentimentRssNewsCountsForSemiAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-attention-sentiment-rss-news-counts-for-semi"
    name = "Weekly Surge In Attention Sentiment Rss News Counts For Semiconductor Export Restrictions"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=semiconductor+export+restrictions&hl=en-US&gl=US&ceid=US:en'], days_back=180)
