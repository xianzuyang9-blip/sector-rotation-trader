...
class WeeklySurgeInRssCountsForPortCongestionNewsSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-rss-counts-for-port-congestion-news-signals-"
    name = "Weekly Surge In Rss Counts For Port Congestion News Signals Industrial Headwinds"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=port+congestion&hl=en-US&gl=US&ceid=US:en'], days_back=180)
