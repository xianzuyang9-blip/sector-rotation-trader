...
class NaturalGasHeatingDemandSpikeViaWeatherExtremesAlgo(CrazyAlgoBase):
    algo_id = "natural-gas-heating-demand-spike-via-weather-extremes"
    name = "Natural Gas Heating Demand Spike Via Weather Extremes"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_weather_series(latitude=39.8283, longitude=-98.5795, days_back=180)
