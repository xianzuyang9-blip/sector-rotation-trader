...
class WeeklySurgeInAttentionsentimentRssCountForShippingCoAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-attentionsentiment-rss-count-for-shipping-co"
    name = "Weekly Surge In Attentionsentiment Rss Count For Shipping Container Backlog Signals Industrial Sector Headwind"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=shipping+container+backlog&hl=en-US&gl=US&ceid=US:en'], days_back=180)
