...
class WeeklySpikeInRssNewsCountsOnPortLaborStrikesSignalAlgo(CrazyAlgoBase):
    algo_id = "weekly-spike-in-rss-news-counts-on-port-labor-strikes-signal"
    name = "Weekly Spike In Rss News Counts On Port Labor Strikes Signals Freight Logistics Disruption"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=port+labor+strike&hl=en-US&gl=US&ceid=US:en'], days_back=180)
