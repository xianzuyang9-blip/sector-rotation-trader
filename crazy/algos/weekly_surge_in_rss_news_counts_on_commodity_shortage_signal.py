...
class WeeklySurgeInRssNewsCountsOnCommodityShortageSignalAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-rss-news-counts-on-commodity-shortage-signal"
    name = "Weekly Surge In Rss News Counts On Commodity Shortage Signals Industrial Sector Headwinds"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=commodity+shortage&hl=en-US&gl=US&ceid=US:en'], days_back=180)
