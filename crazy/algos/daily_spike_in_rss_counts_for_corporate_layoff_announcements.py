...
class DailySpikeInRssCountsForCorporateLayoffAnnouncementsAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-counts-for-corporate-layoff-announcements"
    name = "Daily Spike In Rss Counts For Corporate Layoff Announcements Signals Consumer Discretionary Headwind"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=corporate+layoffs&hl=en-US&gl=US&ceid=US:en'], days_back=180)
