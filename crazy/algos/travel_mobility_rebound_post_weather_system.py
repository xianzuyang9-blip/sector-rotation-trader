...
class TravelMobilityReboundPostWeatherSystemAlgo(CrazyAlgoBase):
    algo_id = "travel-mobility-rebound-post-weather-system"
    name = "Travel Mobility Rebound Post Weather System"
