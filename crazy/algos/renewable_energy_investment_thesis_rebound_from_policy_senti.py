...
class RenewableEnergyInvestmentThesisReboundFromPolicySentiAlgo(CrazyAlgoBase):
    algo_id = "renewable-energy-investment-thesis-rebound-from-policy-senti"
    name = "Renewable Energy Investment Thesis Rebound From Policy Sentiment Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='renewable energy jobs', days_back=180)
