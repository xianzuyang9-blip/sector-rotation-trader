...
class DailySpikeInGoogleTrendsForEmergencyChildcareNearMeAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-for-emergency-childcare-near-me"
    name = "Daily Spike In Google Trends For Emergency Childcare Near Me"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='emergency childcare near me', days_back=180)
