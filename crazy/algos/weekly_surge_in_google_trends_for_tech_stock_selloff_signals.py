...
class WeeklySurgeInGoogleTrendsForTechStockSelloffSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-tech-stock-selloff-signals"
    name = "Weekly Surge In Google Trends For Tech Stock Selloff Signals Rotation To Defensive Sectors"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='tech stock selloff', days_back=180)
