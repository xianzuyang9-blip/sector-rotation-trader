...
class WeeklyRiseInLocaleconomyweirdnessRssCountsMentioningFAlgo(CrazyAlgoBase):
    algo_id = "weekly-rise-in-localeconomyweirdness-rss-counts-mentioning-f"
    name = "Weekly Rise In Localeconomyweirdness Rss Counts Mentioning Food Bank Demand Surge Signals Consumer Hardship Pressure On Staples"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=food+bank+demand+surge&hl=en-US&gl=US&ceid=US:en'], days_back=180)
